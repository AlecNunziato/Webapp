        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><?php if (unserialize($_COOKIE['user'])['permissions'] > 1) { ?><a class="nav-link active" href="managetutor"><i class="fas fa-user"></i><span>Manage Tutors</span></a><?php } ?><a class="nav-link" href="reportsession"><i class="icon-notebook"></i><span>Report Session</span></a></li>
